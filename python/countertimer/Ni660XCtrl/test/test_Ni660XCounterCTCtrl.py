...
# IMPORTANT: use your device name and clock source!
TRIGGER_CHANNEL_DEV_NAMES = 'controls01:10000/io/lab/ictlael01-Dev1-ctr0,'
COUNTER_CHANNEL_DEV_NAMES = 'controls01:10000/io/lab/ictlael01-Dev1-ctr0,' +\
                            'controls01:10000/io/lab/ictlael01-Dev1-ctr2'
SAMPLE_CLK_SRC = '/Dev1/PFI36'

@insertTest(helper_name='hw_continuous_acquisition', offset=0, 
            active_period=0.00001, passive_period=0.01, repetitions=23,
            integ_time=0.01)
@insertTest(helper_name='hw_continuous_acquisition', offset=0, 
...
class Ni660XTriggerGateCTAcqTestCase(AcquisitionTestCase, unittest.TestCase):
    ...
    chn_ctrl_name = '_test_nict_ctrl_1'
    chn_elem_name1 = '_test_nict_1_1'
    chn_elem_name2 = '_test_nict_1_2'
    ...
    POOLPATH.append(_nictrlpath) #Ni660Ctrl
    ...
    def setUp(self):
        ...
        # Still missing import Ni660XTriggerGateController
...
@insertTest(helper_name='hw_step_acquisition', repetitions=2,
            integ_time=0.1)
class Ni660XCTStepAcqTestCase(AcquisitionTestCase, unittest.TestCase):
    """Integration test.
    """
    chn_ctrl_name = '_test_nict_ctrl_1'
    chn_elem_name1 = '_test_nict_1_timer'
    chn_elem_name2 = '_test_nict_1_1'
    ## Configure the fake pool
    _nitestpath = path.dirname( path.abspath(__file__) )
    _nictrlpath = _nitestpath.rsplit('/', 1)[0]
    POOLPATH = list(AcquisitionTestCase.POOLPATH)
    ...
    def setUp(self):
        ...
        ch_ctrl_obj = self.createController(self.chn_ctrl_name,
                                            ...
                                            'Ni660XCounterCTCtrl.py',
                                            ctrl_props)
#         ch_ctrl_obj.set_log_level(logging.DEBUG)        
        self.createCTElement(ch_ctrl_obj, self.chn_elem_name1, 1)
        self.createCTElement(ch_ctrl_obj, self.chn_elem_name2, 2)
        ch_ctrl_obj.set_axis_attr(2, 'sampleclocksource', SAMPLE_CLK_SRC)
        self.channel_names.append(self.chn_elem_name1)
