...
class RadiusController(PseudoMotorController):
    """This pseudomotor controller does the calculation of radius 
       of VCM mirror
       radius = conversion/(bender - radius.PusherOffset)
       bender = conversion/radius + radius.PusherOffset"""
    
    pseudo_motor_roles = ('radius',)
    motor_roles = ('bender',)
                             
    class_prop = { 'conversion':{'Type' : 'PyTango.DevDouble', 'Description' : 'Conversion factor (1/4 steps * km)', 'DefaultValue':1.0}}
