...
#        print "PYTHON -> EigerPSICtrl/",self.inst_name,": In AddDevice method for index",ind
...
#        print "PYTHON -> EigerPSICtrl/",self.inst_name,": In DeleteDevice method for index",ind
        TwoDController.DeleteDevice(self,ind)
        self.proxy[ind-1] =  None
        self.device_available[ind-1] = 0
        
    def StateOne(self,ind):
#        print "PYTHON -> EigerPSICtrl/",self.inst_name,": In StateOne method for index",ind
    ...
    def PreReadAll(self):
#        print "PYTHON -> EigerPSICtrl/",self.inst_name,": In PreReadAll method"
        pass

    def PreReadOne(self,ind):
#        print "PYTHON -> EigerPSICtrl/",self.inst_name,": In PreReadOne method for index",ind
        pass

    def ReadAll(self):
#        print "PYTHON -> EigerPSICtrl/",self.inst_name,": In ReadAll method"
        pass

    def ReadOne(self,ind):
#        print "PYTHON -> EigerPSICtrl/",self.inst_name,": In ReadOne method for index",ind
...
#        print "PYTHON -> EigerPSICtrl/",self.inst_name,": In PreStartAll method"
        pass
...
#        print "PYTHON -> EigerPSICtrl/",self.inst_name,": In StartOne method for index",ind
        self.proxy[ind-1].command_inout("StartAcquisition")
        
    def AbortOne(self,ind):
        #        print "PYTHON -> EigerPSICtrl/",self.inst_name,": In AbortOne method for index",ind
        pass
...
#        print "PYTHON -> EigerPSICtrl/",self.inst_name,": In GetExtraFeaturePar method for index",ind," name=",name
        return 0

    def SetExtraAttributePar(self,ind,name,value):
#        print "PYTHON -> EigerPSICtrl/",self.inst_name,": In SetExtraFeaturePar method for index",ind," name=",name," value=",value
        pass
