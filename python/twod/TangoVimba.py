...
class TangoVimbaCtrl(TwoDController):
    ...
    ctrl_properties = {
        'RootDeviceName': {
            Type: str,
            Description: 'The root name of the TangoVimba Tango devices'},
        'TangoHost': {
            Type: str,
    ...
    def StateOne(self, ind):
        ...
        if self.device_available[ind - 1] == 1:
            ...
            if sta == PyTango.DevState.ON:
                tup = (sta, "Camera ready")
            elif (sta == PyTango.DevState.RUNNING or
                  sta == PyTango.DevState.MOVING or
                  sta == PyTango.DevState.EXTRACT):
