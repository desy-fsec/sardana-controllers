...
class DALSACtrl(TwoDController):
    "This class is the Tango Sardana Two D controller for the DALSA"
    ...
    class_prop = {'RootDeviceName':{Type:str,Description:'The root name of the DALSA Tango devices'},
    ...
    def __init__(self,inst,props, *args, **kwargs):
        ...
        self.ct_name = "DALSACtrl/" + self.inst_name
    ...
    def __del__(self):
        print "PYTHON -> DALSACtrl/",self.inst_name,": dying"
