...
class PseudoCoTangoWrapper(PseudoCounterController):
    ...
    def __init__(self,inst,props):
        ...
        self.counterExtraAttributes[0] = {self.FORMULA:"VALUE",self.EXTERNALATTRIBUTE:""
                                          ,self.ATTRIBUTE:""}
    ...
    def calc(self, index, counter_values):
        ...
        try:
            attribute = self.counterExtraAttributes[0][self.ATTRIBUTE]
            VALUE = self.device_proxy.read_attribute(attribute).value
            return eval(self.counterExtraAttributes[0][self.FORMULA])
        except Exception,e:
            print "[PseudoTangoAttCounter]",self.inst_name,": Some exception fount at calc",e
        return -1
    ...
    def SetExtraAttributePar(self,index,name,value):
        ...
        try:
            ...
            print "[PseudoCoTangoAtt]",self.inst_name,": Some exception found at SetExtraAttributePar",e
...
class PseudoCoTwoTangoAtt(PseudoCounterController):
    ...
    def calc(self,counter_values):
        ...
        try:
            ...
            print "[PseudoTangoAttCounter]",self.inst_name,": Some exception found at calc",e
        return -1
...
class PseudoCounterWrapper(PseudoCounterController):
    ...
    def calc(self, index, counter_values):
        ...
        try:
            ...
            print "[PseudoCounterWrapper]",self.inst_name,": Some exception found at calc",e
        return -1
